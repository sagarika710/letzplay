            ...
            <View style={styles.mainview}>
                <View style={{ margin: 18, }}>
                    ...
                    <View style={styles.couch_view}>
                        <View style={{width:'70%'}}>
                        <Text style={{ fontSize: 14, color: '#717171', fontWeight:'bold', }}>Sagarika Mohanty</Text>
                        <Text style={{ fontSize: 14, color: '#717171',}}>sagarika@gmail.com</Text>
                    ...
                    <View>
                        <View style={{ flexDirection: 'row',justifyContent:'space-between' }}>
                            <View style={styles.location_details}>
                                <Text style={{ fontSize: 13, color: '#717171' }}>Aka Sports Center,</Text>
                        ...
                        <View>
                            <Text style={{ fontSize: 12, color: '#717171',marginTop:20 }}>Slot Booked: 27th Jan 2021, Monday, 09.30AM-11.30AM</Text>
